      ...
      <div className="bg-white rounded-xl border border-gray-200 p-5 sm:p-6 shadow-xs">
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
          ...
          <div className="flex flex-wrap items-center gap-2.5">
            <button
              type="button"
              id="btn-export-judges-tour3-all"
              onClick={() =>
              ...
              title="Générer les feuilles de marque officielles pour les juges de piste du Tour 3 (1 page A4 par poule)"
            >
            ...
            <button
              ...
              title="Exporter et imprimer toutes les poules du Tour 3 en PDF (avec surlignage vert/rouge des qualifiés/éliminés)"
            >
            ...
            >
              ...
              <div className="bg-gray-50/70 px-4 py-3 border-b border-gray-200 flex flex-wrap items-center justify-between gap-2">
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <button
                    type="button"
                    id={`btn-export-judge-poule-t3-${poule.id}`}
                    onClick={() =>
                      exportJudgesScoreSheetPDF({
                        title: 'Olympiades du Rampeau',
                        roundNumber: 3,
                    ...
                    title="Imprimer la feuille de marque pour le juge de piste de cette poule (Tour 3)"
                  >
                  ...
                  <button
                    type="button"
                    id={`btn-export-pdf-poule-t3-${poule.id}`}
                    onClick={() =>
                      exportPoulesToPdf({
                        title: 'Olympiades du Rampeau',
                        roundNumber: 3,
